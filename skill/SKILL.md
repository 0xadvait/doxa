---
name: doxa
description: Use when answering from or growing a verbatim-grounded belief base where every belief must be anchored to exact source quotes.
---

# doxa Skill

Use the installed `doxa` CLI as the source of truth for grounded beliefs.
